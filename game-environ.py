...
def test(func,godisp):
    ...
    circle = body.CreateCircleFixture(radius=0.5, density=.2, friction=0,restitution=1)
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT or (event.type == KEYDOWN and event.key == K_ESCAPE):
                ...
                running = False
        if not godisp:
            movement = func([world.bodies[5].position,world.bodies[4].linearVelocity,world.bodies[4].position])
